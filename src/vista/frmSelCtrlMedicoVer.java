 ...
 * @author USUARIO
 */
public class frmSelCtrlMedicoVer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LblTitulo.setText("Controles medicos de XXXXXX");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSelCtrlMedicoVer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSelCtrlMedicoVer().setVisible(true);
            }
        });
    }
