 ...
 * @author USUARIO
 */
public class frmSelCtrlOperacion extends javax.swing.JFrame {

    /**
     * Creates new form frmVertCtrlOperaciones
     */
    public frmSelCtrlOperacion() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmSelCtrlOperacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmSelCtrlOperacion().setVisible(true);
            }
        });
    }
